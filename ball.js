...
function moveBall() {
  ...
  var Xmin = 0;
  var Xmax = (window.innerWidth - ball.width) + 'px';
  var Ymin = 0;
  var Ymax = (window.innerHeight - ball.height) + 'px';
...
function moveBall2() {
  ...
  var Xmin2 = 0;
  var Xmax2 = window.innerWidth - ball2.width;
  var Ymin2 = 0;
  var Ymax2 = window.innerHeight - ball2.height;
